...
class LocalizeRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('scope')) {
        this.scope = initObj.scope
      }
      else {
        this.scope = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [scope]
    bufferOffset = _serializer.int32(obj.scope, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [scope]
    data.scope = _deserializer.int32(buffer, bufferOffset);
    return data;
  }
...
module.exports = {
  ...
  md5sum() { return 'a308643c2731f421c811b956395b3a0b'; },
  datatype() { return 'localizer/Localize'; }
};
