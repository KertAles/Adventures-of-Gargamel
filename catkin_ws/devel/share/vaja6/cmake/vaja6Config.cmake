...
if(vaja6_CONFIG_INCLUDED)
  return()
endif()
set(vaja6_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(vaja6_SOURCE_PREFIX /home/avrelij/Documents/RINS/catkin_ws/src/vaja6)
  set(vaja6_DEVEL_PREFIX /home/avrelij/Documents/RINS/catkin_ws/devel)
  set(vaja6_INSTALL_PREFIX "")
  set(vaja6_PREFIX ${vaja6_DEVEL_PREFIX})
else()
  set(vaja6_SOURCE_PREFIX "")
  set(vaja6_DEVEL_PREFIX "")
  set(vaja6_INSTALL_PREFIX /home/avrelij/Documents/RINS/catkin_ws/install)
  set(vaja6_PREFIX ${vaja6_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'vaja6' is deprecated")
...
set(vaja6_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/usr/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/jsoncpp;/usr/include/python2.7;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/tcl;/usr/include/libxml2 " STREQUAL " ")
  set(vaja6_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include;/usr/include/pcl-1.7;/usr/include/eigen3;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/jsoncpp;/usr/include/python2.7;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/tcl;/usr/include/libxml2")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${vaja6_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'vaja6' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'vaja6' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avrelij/Documents/RINS/catkin_ws/src/vaja6/${idir}'.  ${_report}")
    endif()
    _list_append_unique(vaja6_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND vaja6_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND vaja6_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT vaja6_NUM_DUMMY_TARGETS)
      set(vaja6_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::vaja6::wrapped-linker-option${vaja6_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR vaja6_NUM_DUMMY_TARGETS "${vaja6_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::vaja6::wrapped-linker-option${vaja6_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND vaja6_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/avrelij/Documents/RINS/catkin_ws/devel/lib;/home/avrelij/Documents/RINS/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(vaja6_LIBRARY_DIRS ${lib_path})
      list(APPEND vaja6_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'vaja6'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND vaja6_LIBRARIES ${lib})
    endif()
  endif()
...
set(vaja6_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${vaja6_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 vaja6_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${vaja6_dep}_FOUND)
      find_package(${vaja6_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${vaja6_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(vaja6_INCLUDE_DIRS ${${vaja6_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(vaja6_LIBRARIES ${vaja6_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${vaja6_dep}_LIBRARIES})
  _list_append_deduplicate(vaja6_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(vaja6_LIBRARIES ${vaja6_LIBRARIES})

  _list_append_unique(vaja6_LIBRARY_DIRS ${${vaja6_dep}_LIBRARY_DIRS})
  list(APPEND vaja6_EXPORTED_TARGETS ${${vaja6_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${vaja6_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
