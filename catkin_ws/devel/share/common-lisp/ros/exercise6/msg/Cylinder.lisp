...
(cl:defmethod cl:initialize-instance :after ((m <Cylinder>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Cylinder)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exercise6-msg:<Cylinder> is deprecated: use exercise6-msg:Cylinder instead.")))
...
(cl:defmethod app_x-val ((m <Cylinder>))
...
(cl:defmethod app_y-val ((m <Cylinder>))
...
(cl:defmethod app_z-val ((m <Cylinder>))
