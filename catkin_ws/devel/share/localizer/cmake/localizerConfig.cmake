...
if(NOT "/home/avrelij/Documents/RINS/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localizer' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/avrelij/Documents/RINS/catkin_ws/src/vicos_ros/depth/localizer/${idir}'.  ${_report}")
    endif()
