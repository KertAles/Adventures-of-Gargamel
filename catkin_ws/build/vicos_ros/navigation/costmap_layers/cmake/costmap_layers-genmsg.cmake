...
set(MSG_I_FLAGS "-Icostmap_layers:/home/avrelij/Documents/RINS/catkin_ws/src/vicos_ros/navigation/costmap_layers/msg;-Isensor_msgs:/opt/ros/kinetic/share/sensor_msgs/cmake/../msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/kinetic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/avrelij/Documents/RINS/catkin_ws/src/vicos_ros/navigation/costmap_layers/msg/Wall.msg" NAME_WE)
add_custom_target(_costmap_layers_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "costmap_layers" "/home/avrelij/Documents/RINS/catkin_ws/src/vicos_ros/navigation/costmap_layers/msg/Wall.msg" "geometry_msgs/Point"
)
...
_generate_msg_cpp(costmap_layers
  "/home/avrelij/Documents/RINS/catkin_ws/src/vicos_ros/navigation/costmap_layers/msg/Wall.msg"
  "${MSG_I_FLAGS}"
...
### Generating Messages
_generate_msg_eus(costmap_layers
  "/home/avrelij/Documents/RINS/catkin_ws/src/vicos_ros/navigation/costmap_layers/msg/Wall.msg"
  "${MSG_I_FLAGS}"
  "/opt/ros/kinetic/share/geometry_msgs/cmake/../msg/Point.msg"
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/costmap_layers
)

### Generating Services

### Generating Module File
_generate_module_eus(costmap_layers
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/costmap_layers
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(costmap_layers_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(costmap_layers_generate_messages costmap_layers_generate_messages_eus)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/avrelij/Documents/RINS/catkin_ws/src/vicos_ros/navigation/costmap_layers/msg/Wall.msg" NAME_WE)
add_dependencies(costmap_layers_generate_messages_eus _costmap_layers_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(costmap_layers_geneus)
add_dependencies(costmap_layers_geneus costmap_layers_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS costmap_layers_generate_messages_eus)
...
### Generating Messages
_generate_msg_nodejs(costmap_layers
  "/home/avrelij/Documents/RINS/catkin_ws/src/vicos_ros/navigation/costmap_layers/msg/Wall.msg"
  "${MSG_I_FLAGS}"
  "/opt/ros/kinetic/share/geometry_msgs/cmake/../msg/Point.msg"
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/costmap_layers
)

### Generating Services

### Generating Module File
_generate_module_nodejs(costmap_layers
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/costmap_layers
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(costmap_layers_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(costmap_layers_generate_messages costmap_layers_generate_messages_nodejs)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/avrelij/Documents/RINS/catkin_ws/src/vicos_ros/navigation/costmap_layers/msg/Wall.msg" NAME_WE)
add_dependencies(costmap_layers_generate_messages_nodejs _costmap_layers_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(costmap_layers_gennodejs)
add_dependencies(costmap_layers_gennodejs costmap_layers_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS costmap_layers_generate_messages_nodejs)
...
if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/costmap_layers)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/costmap_layers
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET sensor_msgs_generate_messages_eus)
  add_dependencies(costmap_layers_generate_messages_eus sensor_msgs_generate_messages_eus)
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(costmap_layers_generate_messages_eus std_msgs_generate_messages_eus)
endif()
if(TARGET geometry_msgs_generate_messages_eus)
  add_dependencies(costmap_layers_generate_messages_eus geometry_msgs_generate_messages_eus)
endif()
...
if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/costmap_layers)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/costmap_layers
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET sensor_msgs_generate_messages_nodejs)
  add_dependencies(costmap_layers_generate_messages_nodejs sensor_msgs_generate_messages_nodejs)
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(costmap_layers_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()
if(TARGET geometry_msgs_generate_messages_nodejs)
  add_dependencies(costmap_layers_generate_messages_nodejs geometry_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/costmap_layers)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/costmap_layers\")")
  # install generated code
  install(
